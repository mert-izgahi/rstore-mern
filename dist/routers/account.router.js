...
router.post("/auth-as-guest", (0, trycatch_middleware_1.tryCatch)(account_controller_1.authAsGuest));
...
router.put("/toggle-account-block-by-id/:id", auth_middleware_1.withAuth, (0, auth_middleware_1.authorizedFor)("admin", "guest"), (0, trycatch_middleware_1.tryCatch)(account_controller_1.toggleBlockById));
...
router.get("/get-accounts", auth_middleware_1.withAuth, (0, auth_middleware_1.authorizedFor)("admin", "guest"), (0, trycatch_middleware_1.tryCatch)(account_controller_1.getAccounts));
router.get("/get-account/:id", auth_middleware_1.withAuth, (0, auth_middleware_1.authorizedFor)("admin", "guest"), (0, trycatch_middleware_1.tryCatch)(account_controller_1.getAccountById));
